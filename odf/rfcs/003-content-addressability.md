...
We will also expand the use of `multihash` format proposed in [RFC-002](/odf/rfcs/002-logical-data-hashes.md) to all hashes, removing the use of `sha3-256` schema format.
