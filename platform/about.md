...
<div class="badges">
  ...
  <a href="https://github.com/kamu-data/kamu-web-ui/releases/latest">
    <img 
      src="https://img.shields.io/github/v/release/kamu-data/kamu-web-ui?include_prereleases&logo=angular&logoColor=orange&style=for-the-badge"
      noZoom/>
  </a>
  <a href="https://github.com/kamu-data/kamu-web-ui/actions">
    <img 
      src="https://img.shields.io/github/actions/workflow/status/kamu-data/kamu-web-ui/build.yaml?logo=githubactions&label=CI&logoColor=white&style=for-the-badge&branch=master"
      noZoom/>
  </a>
</div>
